...
const UpdateProduct = () => {
  ...
  const validationSchema = Yup.object({
    title: Yup.string()
      .required("Required")
      .min(3, "Invalid Product name")
      .max(100, "Invalid Product name"),
    description: Yup.string()
      .required("Required")
      .min(3, "Invalid description"),
    ...
    brand: Yup.string(),
    size: Yup.array().of(
      Yup.string().oneOf(["sm", "md", "lg", "xl"], "invalid")
    ),
  ...
  const { data: categories } = useQuery(
    ...
    getAllCategoires,
    {
      onSuccess: (res) => {
        ...
        if (productData) {
          const ca = res.data.documents.filter(
            (category, index) => category.name === productData.category.name
          );
  ...
  const { data } = useQuery(
    ...
    getAllSubCategoreisforCategory,
    {
      onSuccess: (res) => {
    ...
    <div className={style.AddProduct}>
      ...
      >
        {({ values, setFieldValue, isValid, handleSubmit }) => {
          ...
          const isAddSizeButtonDisabled =
            !["sm", "md", "lg", "xl"].includes(tempSize) ||
            values.size.includes(tempSize);
          ...
          const isAddColorButtonDisabled =
            !tempColor.trim() || values.colors.includes(tempColor.trim());
                ...
                <div>
                  <div className={style.formGroup}>
                    ...
                    <div className={style.formSubGroup}>
                      <div className={style.subGroup}>
                        ...
                        <div>
                          <div style={{ padding: "10px 0" }}>
                            {values.size.map((s, i) => (
                              <span key={i} className={style.displaySizes}>
                                {s}
                              </span>
                            ))}
                          </div>
                      ...
                      <div className={style.subGroup}>
                        <label htmlFor="color" className={style.colorLabel}>
                          Color
                        </label>
                        <div>
                          <FormController
                  ...
                  <div className={style.formGroup}>
                    ...
                    >
                      <div className={style.formInput}>
                        <label
                          htmlFor="imageCover"
                          className={style.uploadImgProduct}
                        >
                          <i className="fa-solid fa-cloud-arrow-up"></i> click
                          here to upload image cover
                        </label>
                        <FormController
                          control="input"
                          type="file"
                      ...
                      <div
                        ...
                        style={{
                          ...
                          backgroundImage: imageCoverCopyShow
                            ? `url(${imageCoverCopyShow})`
                            : "none",
                  ...
                  <div className={style.formGroup}>
                    ...
                    >
                      ...
                      <div
                        style={{
                          display:
                            multiImagesCopyShow.length > 0 ? "flex" : "none",
                          display: "flex",
                          width: "100%",
                      ...
                      >
                        {multiImagesCopyShow.map((image, index) => (
                          <div
                            ...
                            style={{
                              backgroundImage: multiImagesCopyShow
                                ? `url(${image})`
                                : "none",
                              width: "45%",
                              height: "150px",
